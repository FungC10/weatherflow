...
export default function LoadingShimmer({ type = 'card' }: LoadingShimmerProps) {
  if (type === 'full') {
    return (
      <div className="space-y-6">
          ...
          <div className="animate-pulse">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <div className="h-12 bg-slate-700 rounded w-20 mb-2"></div>
        ...
        <div className="space-y-3">
          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-slate-700/30">
              <div className="animate-pulse">
